...
public class ActivitiProcessService {
    ...
    public void listRunProcess(HttpModel httpModel){
        ...
        List runProcesslist = processInstanceQuery.listPage(inDto.getPageStart(),inDto.getPageLimit());
        httpModel.setOutMsg(AOSJson.toGridJson(runProcesslist, (int)processInstanceQuery.count()));
    }
