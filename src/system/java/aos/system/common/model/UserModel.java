...
public class UserModel implements Serializable{
	 ...
	 * 角色集合
	 */
	private List<AosRolePO> aosRolePOs;
	...
	public boolean isAdmin() {
		return isAdmin(this.account);
	}

	public static boolean isAdmin(String userId) {
		return userId != null && "root".equals(userId);
	}
	...
	public List<AosRolePO> getAosRolePOs() {
		return aosRolePOs;
	}

	public void setAosRolePOs(List<AosRolePO> aosRolePOs) {
		this.aosRolePOs = aosRolePOs;
	}
