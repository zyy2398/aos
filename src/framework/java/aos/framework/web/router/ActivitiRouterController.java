...
@Controller
public class ActivitiRouterController implements ModelDataJsonConstants {
    protected static final Logger LOGGER = LoggerFactory.getLogger(ActivitiRouterController.class);
