...
import aos.framework.core.annotation.DSKey;
import aos.framework.core.annotation.UseDataSource;
import aos.framework.core.utils.CustomSpelParser;
import aos.framework.core.utils.DataSourceSwitcher;
...
public class DataSourceAsp implements InitializingBean {
     ...
     * pointcut
     */
    @Pointcut("@annotation(aos.framework.core.annotation.UseDataSource)")
